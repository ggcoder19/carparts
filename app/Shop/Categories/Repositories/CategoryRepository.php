...
class CategoryRepository extends BaseRepository implements CategoryRepositoryInterface
{
    ...
    public function getProducts($b, $m, $s, $p, $sp, $pi){
        $query = "Select * from products WHERE brand_id = '$b' AND car_model = '$m' AND car_submodel = '$s' and is_part = '$p' AND sub_part = '$sp' AND FIND_IN_SET('$pi', pieces)";
